...
$tables = array(
  ...
  'Jobs' => array(
    'mysql'  => "CREATE TABLE IF NOT EXISTS `".TBL_JOBS."` (
                        ...
                        `Job_assigned_to_chainedgroup_A` INTEGER unsigned NOT NULL DEFAULT '0',
                        `Job_assigned_to_chainedgroup_B` INTEGER unsigned NOT NULL DEFAULT '0',
                        `Job_assigned_to_chainedgroup_C` INTEGER unsigned NOT NULL DEFAULT '0',
                        `Job_assigned_to_chainedgroup_D` INTEGER unsigned NOT NULL DEFAULT '0',
    ...
    'sqlite' => "CREATE TABLE IF NOT EXISTS ".TBL_JOBS." (
                        ...
                        Job_assigned_to_chainedgroup_C INTEGER    NOT NULL DEFAULT 0,
                        Job_assigned_to_chainedgroup_D INTEGER    NOT NULL DEFAULT 0,
